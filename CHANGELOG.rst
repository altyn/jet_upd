...
* PR-*: Django 3.2 compatability fix
* PR-*: Fix models pk BigAutoIncrement
* PR-*: Moved from django urls to path
* PR-*: Removed python_2_unicode_compatible decorators
* PR-*: smart_text and force_text changed to smart_str and force_str
